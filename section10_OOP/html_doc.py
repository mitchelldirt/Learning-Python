...
if __name__ == '__main__':
    ...
    # my_page.add_tag('p', 'This is a paragraph that will apear on the page')
    ...
    new_body.add_tag('p', "The composed objects don't actually own the objects that it's composed of"
