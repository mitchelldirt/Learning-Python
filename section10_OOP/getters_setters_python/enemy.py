# Importing random module for the vampire subclass
import random


# Class Enemy is a subclass of `object`.
class Enemy:
...
# `Troll` is a subclass of `Enemy` and `Enemy` is a superclass of `Troll`.
class Troll(Enemy):
...
class VampireKing(Vampire):
    ...
    def __init__(self, name):
        super().__init__(name)
        # Self._hit_points MUST come after the initialization
